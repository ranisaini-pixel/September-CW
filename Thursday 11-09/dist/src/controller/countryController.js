...
exports.deleteCountry = exports.updateCountry = exports.searchCountryByName = exports.getCountryByName = exports.getCountryList = exports.createCountry = void 0;
...
const searchCountryByName = async (req, res) => {
    try {
        ...
        const countryName = await countryModel_1.default.find({ name });
        //fix it
        if (!countryName) {
            return res.status(400).json({
                message: "Country not found",
...
exports.searchCountryByName = searchCountryByName;
