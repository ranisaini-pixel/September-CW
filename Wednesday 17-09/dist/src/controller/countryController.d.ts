...
export declare const createCountry: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const getCountryList: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const getCountryById: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
