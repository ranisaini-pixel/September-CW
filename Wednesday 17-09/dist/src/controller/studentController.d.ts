...
export declare const loginStudent: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const getStudentById: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const getStudentList: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
