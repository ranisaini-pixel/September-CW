...
export declare const getCityList: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const getCityByName: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
